package test.cmcc.com.interfacedemo;
...
public class MainActivity extends AppCompatActivity implements TestCallBack, InterfacedCallBack {
    ...
    private void TestOne() {
        TestCallBackUtils.requestData(this, "网络请求地址", new TestCallBack() {
            ...
            public void onFinish(String respose) {
                Toast.makeText(MainActivity.this, "静态方法回调1: onFinish ", Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onError(Exception e) {
                Toast.makeText(MainActivity.this, "静态方法回调1:  onError", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    @Override
    public void onFinish(String respose) {
        Toast.makeText(MainActivity.this, "静态方法回调2: onFinish", Toast.LENGTH_SHORT).show();
    }

    @Override
    public void onError(Exception e) {
        Toast.makeText(MainActivity.this, "静态方法回调2: onError ", Toast.LENGTH_SHORT).show();
    }
    ...
    public void onMessage(String respose) {
        Toast.makeText(MainActivity.this, "类对象回调: " + respose, Toast.LENGTH_SHORT).show();
    }
    ...
    private void TestFour() {
        ...
        testCallBackUtils.setThreeCallBack(new InterfacedCallBack() {
            @Override
            public void onMessage(String respose) {
                Toast.makeText(MainActivity.this, "类对象回调匿名内部类: " + respose, Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void TestFifty() {
        TestCallBackUtils.setCallBack(new InterfacedCallBack() {
            @Override
            public void onMessage(String respose) {
                Toast.makeText(MainActivity.this, respose, Toast.LENGTH_SHORT).show();
            }
        });
    }
